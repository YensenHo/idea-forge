                ...
                <Link key={p.id} href={'/posts/'+p.id} className="block group animate-in"
                  ...
                  <article className="card-pinned relative overflow-hidden" style={{padding:'24px'}}>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2 text-[12px] text-[#665c56]">
                        {p.bounty > 0 && <><span className="font-bold text-[#a8573e]">¥{p.bounty}</span><span className="text-[#c9beb4]">·</span></>}
