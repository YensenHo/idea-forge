                ...
                <Link key={p.id} href={'/posts/'+p.id} className="block group animate-in"
                  ...
                  <article className="card-pinned relative overflow-hidden" style={{padding:'24px'}}>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center text-[12px] text-[#665c56]" style={{gap:'16px'}}>
                        {p.bounty > 0 && <span className="font-bold text-[#a8573e]" style={{minWidth:'40px'}}>¥{p.bounty}</span>}
                        <span className="flex items-center" style={{gap:'4px',minWidth:'36px'}}>
                        ...
                        <span className="italic" style={{minWidth:'50px'}}>{fmt(p.created_at)}</span>
                      </div>
                    </div>
                  </article>
                </Link>
